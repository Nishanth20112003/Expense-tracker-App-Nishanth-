                  ...
                  <tr key={item.id} className="table-data">
                    <td>
                      <p
                        className={
                          item.type === "expense"
                            ? "text-orange-600 text-lg bg-orange-100 w-[fit-content] rounded-full py-1 px-3"
                            : "text-green-600 text-lg bg-green-100 w-[fit-content] rounded-full py-1 px-4"
                        }
                      >
                    ...
                    <td className="text-gray-800 font-semibold">{item.date}</td>
                    <td className="text-gray-800 font-semibold">
